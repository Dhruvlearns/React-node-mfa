...
const TwoFASetup = ({onSetupComplete}) => {
    ...
    const copyClipBoard=async ()=>{
        ...
        setMessage("secret cpoied to clipboard");
    };

    return (
        <div 
      className='bg-white rounded-lg shadow-md max-w-sm  mx-auto'>
        <div className='pt-6'>
        ...
        <button onClick={onSetupComplete} className='w-full bg-blue-500 text-white py-2 rounded-md  '>Continue to Verfication </button>
        </div>
    </div>
    );
};
